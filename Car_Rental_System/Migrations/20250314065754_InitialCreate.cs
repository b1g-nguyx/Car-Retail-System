        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LicensePlates = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false),
                    ...
                    Status = table.Column<int>(type: "int", nullable: false),
                    PaymentPendingAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ContractId = table.Column<int>(type: "int", nullable: false),
                    ViolationDetails = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: false),
                    FineAmount = table.Column<decimal>(type: "decimal(18,2)", nullable: false),
                    ViolationDate = table.Column<DateTime>(type: "datetime2", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_ViolationHistories", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ViolationHistories_Contracts_ContractId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ViolationHistories_ContractId",
                table: "ViolationHistories",
                column: "ContractId");
        }
